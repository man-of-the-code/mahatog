  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.posts}>
        ...
        {/* Culture post */}
        <Card postImage={"/jhijhiyaDance.webp"} postDate={"05-02-2025"} postCategory={"Culture"} postTitle={"Mithila's Jhijhiya Dance: A Vibrant Expression of Cultural Devotion"} postDesc={"Jhijhiya is a traditional folk dance of the Mithila region in Bihar and eastern Uttar Pradesh, celebrated with great enthusiasm during the Navratri festival. This unique and captivating dance form is a symbol of devotion, joy, and cultural heritage, showcasing the deep-rooted traditions of the region."} />
